...
The planner can combine multiple services in a single request.

![Multi-Tool Demo](assets/multi_tool_demo.png)

### Retrieval-Augmented Generation

Destination-specific questions can be grounded in the local travel knowledge base.

![RAG Demo](assets/rag_demo.png)

### Tourism Analytics

Structured tourism data is queried and calculated directly rather than generated by the LLM.
